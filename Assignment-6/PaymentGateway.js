...
export function payment(req, res) {
    ...
    */
    var paytmChecksum = generateSignature(params, process.env.PAYTM_MERCHANT_KEY);
...
export function callback(req, res) {
    ...
    form.parse(req, (err, fields, file) => {
        ...
        var isVerifySignature = verifySignature(fields, process.env.PAYTM_MERCHANT_KEY, paytmChecksum);
        if (isVerifySignature) {
            ...
            * Find your Merchant Key in your Paytm Dashboard at https://dashboard.paytm.com/next/apikeys 
            */
            generateSignature(paytmParams, process.env.PAYTM_MERCHANT_KEY).then(function (checksum) {
